...
class CppKernel(Kernel):
    ...
    def apply_acc_helper(self, reduction_type, dtype, use_scalar):
        ...
        if reduction_type == "sum" and dtype != torch.bool:
            ...
            print("reduction_size: ", reduction_size)
            print("Integer reduction_size: ", isinstance(reduction_size, sympy.Integer))
...
class CppVecKernel(CppKernel):
    ...
    def reduction(self, dtype, src_dtype, reduction_type, value):
        ...
        should_use_acc_hepler = self.apply_acc_helper(reduction_type, src_dtype, False)
