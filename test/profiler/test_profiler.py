...
"""
    ...
    def test_disable_external_correlation(self):
        ...
        # Run with External Id for CUDA events on
        disable_external_correlation = False
        with profile(
        ...
        validate_json(prof_on, disable_external_correlation)

        # Run with External Id for CUDA events off
        ...
        with profile(
            ...
            self.payload(use_cuda=True)
        validate_json(prof_off, disable_external_correlation)
